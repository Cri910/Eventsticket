const Palette = () => {
  return (
    <footer className="w-[734px] rounded-8xs box-border overflow-hidden flex flex-row items-start justify-between pt-[51px] pb-[31px] pr-[9px] pl-[31px] text-left text-11xl text-silver font-poppins border-[1px] border-solid border-blueviolet-100">

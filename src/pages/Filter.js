  ...
  return (
    <div className="w-full h-[812px] relative bg-ghostwhite overflow-hidden flex flex-col items-center justify-start pt-[153px] pb-0 pr-0 pl-5 box-border gap-[640px]">
      <div className="self-stretch flex flex-row items-start justify-start py-0 px-0">
        <nav className="m-0 flex flex-row items-start justify-start gap-[16px] z-[3] text-center text-sm text-butt3 font-space-grotesk">
      ...
      <div className="w-[375px] absolute my-0 mx-[!important] h-full top-[0px] right-[-1px] bottom-[0px] bg-gray-500" />
      <main className="w-full h-[754px] absolute my-0 mx-[!important] right-[0.4px] bottom-[-0.4px] left-[-0.4px]">
        <section className="absolute w-[calc(100%_-_28px)] top-[-0.4px] right-[13.6px] left-[14.4px] rounded-t-19xl rounded-b-none bg-background-dropdown-background-color [filter:blur(5.44px)] h-[732px] opacity-[0.5] mix-blend-normal z-[1]" />
        <form className="m-0 absolute top-[12.6px] left-[0.4px] rounded-t-19xl rounded-b-none bg-gray-200 w-[375px] h-[741px] z-[2]">
          <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] rounded-t-19xl rounded-b-none bg-gray-200 hidden" />
          <div className="absolute h-[0.67%] w-[6.93%] top-[1.62%] right-[46.67%] bottom-[97.71%] left-[46.4%] rounded-[2.5px] bg-darkgray-200 z-[1]" />
          ...
          <button className="cursor-pointer [border:none] p-0 bg-color-primary-blue absolute top-[665px] left-[169px] rounded-sm w-[185px] h-[58px] z-[3]">
            <img
              ...
              src="/rectangle.svg"
            />
            <div className="absolute top-[calc(50%_-_10.6px)] left-[36.54%] text-base tracking-[1px] uppercase font-medium font-space-grotesk text-background-dropdown-background-color text-center z-[1]">
              Apply
            </div>
          </button>
          <button className="cursor-pointer p-0 bg-background-dropdown-background-color absolute top-[665px] left-[20px] rounded-sm box-border w-[130px] h-[58px] z-[3] border-[1px] border-solid border-butt3">
            ...
            <div className="absolute top-[calc(50%_-_10.1px)] left-[29.92%] text-base tracking-[1px] uppercase font-medium font-space-grotesk text-color-typography-title text-center z-[1]">
              Reset
            </div>
          </button>
          <h3 className="m-0 absolute top-[28.4px] left-[19.6px] text-6xl leading-[133.33%] font-light font-space-grotesk text-butt3 text-left flex items-center z-[3]">
            Filter
          </h3>
          ...
          <div className="absolute top-[375.4px] left-[19.6px] text-base leading-[34px] font-medium font-space-grotesk text-color-typography-title text-left flex items-center z-[3]">
            Location
          </div>
          ...
          <button className="cursor-pointer p-0 bg-background-dropdown-background-color absolute top-[252px] left-[20px] rounded-3xs box-border w-[81px] h-[42px] z-[3] border-[1px] border-solid border-gainsboro-100">
            ...
            <div className="absolute top-[8.4px] left-[17.6px] text-mini leading-[25px] font-light font-space-grotesk text-gray-100 text-center z-[1]">
              Today
            </div>
          </button>
          <button className="cursor-pointer [border:none] p-0 bg-color-primary-blue absolute top-[252px] left-[113px] rounded-3xs w-[110px] h-[42px] z-[3]">
            ...
            <div className="absolute top-[8.4px] left-[19.6px] text-mini leading-[25px] font-light font-space-grotesk text-background-dropdown-background-color text-center z-[1]">
              Tomorrow
            </div>
          </button>
          <button className="cursor-pointer p-0 bg-background-dropdown-background-color absolute top-[252px] left-[235px] rounded-3xs box-border w-[107px] h-[42px] z-[3] border-[1px] border-solid border-gainsboro-100">
            ...
            <div className="absolute top-[8.4px] left-[14.6px] text-mini leading-[25px] font-light font-space-grotesk text-gray-100 text-center z-[1]">
              This week
            </div>
          </button>
      ...
      <footer className="self-stretch flex flex-row items-start justify-start py-0 pr-[23px] pl-[3px] text-left text-smi text-blueviolet-200 font-space-grotesk">
        <div className="flex-1 rounded-sm bg-background-dropdown-background-color flex flex-row flex-wrap items-start justify-start pt-2 pb-[9px] pr-[11px] pl-2 gap-[12px]">
          ...
          <div className="flex-1 flex flex-col items-start justify-start gap-[11px] min-w-[133px]">
            <div className="self-stretch h-16 flex flex-col items-start justify-start gap-[4px]">
              <div className="self-stretch h-5 flex flex-row items-end justify-between">
            ...
            <div className="w-[189px] h-[17px] flex flex-row items-end justify-start gap-[6px] text-darkgray-100">
